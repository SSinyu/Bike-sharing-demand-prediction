...
parser.add_argument("--hidden_size", dest="hidden_size", type=int, default=200, help="dimensionality of hidden layer (default:200)")
...
parser.add_argument("--learning_rate", dest="learning_rate", type=float, default=1e-5, help="learning rate (default:1e-5)")
parser.add_argument("--decay_rate", dest="decay_rate", type=float, default=0.95, help="learning rate decay rate (default:0.95)")
